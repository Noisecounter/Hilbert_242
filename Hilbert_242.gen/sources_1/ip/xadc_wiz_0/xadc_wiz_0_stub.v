...
//               c:/PoC/Hilbert242C/Hilbert_242.gen/sources_1/ip/xadc_wiz_0/xadc_wiz_0_stub.v
// Design      : xadc_wiz_0
...
module xadc_wiz_0(daddr_in, den_in, di_in, dwe_in, do_out, drdy_out, 
  dclk_in, reset_in, convst_in, vauxp7, vauxn7, vauxp15, vauxn15, busy_out, channel_out, eoc_out, 
  eos_out, alarm_out, muxaddr_out, vp_in, vn_in)
/* synthesis syn_black_box black_box_pad_pin="daddr_in[6:0],den_in,di_in[15:0],dwe_in,do_out[15:0],drdy_out,reset_in,convst_in,vauxp7,vauxn7,vauxp15,vauxn15,busy_out,channel_out[4:0],eoc_out,eos_out,alarm_out,muxaddr_out[4:0],vp_in,vn_in" */
