...
--               c:/PoC/Hilbert242C/Hilbert_242.gen/sources_1/ip/fir_compiler_1/fir_compiler_1_stub.vhdl
...
entity fir_compiler_1 is
  ...
  attribute core_generation_info of fir_compiler_1 : entity is "fir_compiler_1,fir_compiler_v7_2_23,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=fir_compiler,x_ipVersion=7.2,x_ipCoreRevision=23,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_XDEVICEFAMILY=zynq,C_ELABORATION_DIR=./,C_COMPONENT_NAME=fir_compiler_1,C_COEF_FILE=fir_compiler_1.mif,C_COEF_FILE_LINES=265,C_FILTER_TYPE=0,C_INTERP_RATE=1,C_DECIM_RATE=1,C_ZERO_PACKING_FACTOR=1,C_SYMMETRY=0,C_NUM_FILTS=1,C_NUM_TAPS=265,C_NUM_CHANNELS=1,C_CHANNEL_PATTERN=fixed,C_ROUND_MODE=1,C_COEF_RELOAD=0,C_NUM_RELOAD_SLOTS=1,C_COL_MODE=1,C_COL_PIPE_LEN=4,C_COL_CONFIG=1,C_OPTIMIZATION=0,C_DATA_PATH_WIDTHS=12,C_DATA_IP_PATH_WIDTHS=12,C_DATA_PX_PATH_WIDTHS=12,C_DATA_WIDTH=12,C_COEF_PATH_WIDTHS=8,C_COEF_WIDTH=8,C_DATA_PATH_SRC=0,C_COEF_PATH_SRC=0,C_PX_PATH_SRC=0,C_DATA_PATH_SIGN=1,C_COEF_PATH_SIGN=0,C_ACCUM_PATH_WIDTHS=24,C_OUTPUT_WIDTH=12,C_OUTPUT_PATH_WIDTHS=12,C_ACCUM_OP_PATH_WIDTHS=24,C_EXT_MULT_CNFG=none,C_DATA_PATH_PSAMP_SRC=0,C_OP_PATH_PSAMP_SRC=0,C_NUM_MADDS=1,C_OPT_MADDS=none,C_OVERSAMPLING_RATE=265,C_INPUT_RATE=1000,C_OUTPUT_RATE=1000,C_DATA_MEMTYPE=1,C_COEF_MEMTYPE=1,C_IPBUFF_MEMTYPE=0,C_OPBUFF_MEMTYPE=0,C_DATAPATH_MEMTYPE=0,C_MEM_ARRANGEMENT=0,C_DATA_MEM_PACKING=1,C_COEF_MEM_PACKING=1,C_FILTS_PACKED=1,C_LATENCY=272,C_HAS_ARESETn=0,C_HAS_ACLKEN=0,C_DATA_HAS_TLAST=0,C_S_DATA_HAS_FIFO=1,C_S_DATA_HAS_TUSER=0,C_S_DATA_TDATA_WIDTH=16,C_S_DATA_TUSER_WIDTH=1,C_M_DATA_HAS_TREADY=0,C_M_DATA_HAS_TUSER=0,C_M_DATA_TDATA_WIDTH=16,C_M_DATA_TUSER_WIDTH=1,C_HAS_CONFIG_CHANNEL=0,C_CONFIG_SYNC_MODE=0,C_CONFIG_PACKET_SIZE=0,C_CONFIG_TDATA_WIDTH=1,C_RELOAD_TDATA_WIDTH=1}";
