...
module Hilbert_242 (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Hilbert_242_sys_clock, ASSOCIATED_RESET btn_2, INSERT_VIP 0" *)
  input sys_clock;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.BTN_1 RST" *)
  (* X_INTERFACE_MODE = "slave RST.BTN_1" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.BTN_1, POLARITY ACTIVE_HIGH, INSERT_VIP 0" *)
  input btn_1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.BTN_2 RST" *)
  (* X_INTERFACE_MODE = "slave RST.BTN_2" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.BTN_2, POLARITY ACTIVE_HIGH, INSERT_VIP 0" *)
  input btn_2;
  (* X_INTERFACE_IGNORE = "true" *)
  input btn_0;
