...
##Clock signal
create_clock -period 8.000 -name clk_in1 -waveform {0.000 4.000} -add [get_ports sys_clock]

## 1) Create a virtual master clock (frequency arbitrary; ratios matter)
#create_clock -name ps_fclk_master -period 1.000

## 2) Tell Vivado each FCLK is generated from that master
##    Example: 100 MHz and 50 MHz
#create_generated_clock -name clk_fpga_0 -source [get_clocks ps_fclk_master] -divide_by 100 [get_pins processing_system7_0/FCLK_CLK0]
#create_generated_clock -name clk_fpga_1 -source [get_clocks ps_fclk_master] -divide_by 200 [get_pins processing_system7_0/FCLK_CLK1]



#USB-RS232 Interface
#set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports RsTx]; #did not work! On Baysy3 it did...
#set_property -dict { PACKAGE_PIN B12   IOSTANDARD LVCMOS33 } [get_ports RsRx];

##Switches
set_false_path -from [get_ports switch1_0]
set_false_path -from [get_ports switch2_0]
#set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { sw[2] }]; #IO_L4N_T0_34 Sch=sw[2]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { sw[3] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]


##Buttons
set_false_path -from [get_ports btn_0]
set_false_path -from [get_ports btn_1]
set_false_path -from [get_ports btn_2]
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { btn_tri_io[3] }]; #IO_L7P_T1_34 Sch=btn[3]


##LEDs
set_false_path -to [get_ports led1_0]
set_false_path -to [get_ports led2_0]
...
##Pmod Header JC
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { JC_0[2] }]; #IO_L1P_T0_34 Sch=jc_p[2]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { JC_0[3] }]; #IO_L1N_T0_34 Sch=jc_n[2]
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { JC_0[4] }]; #IO_L8P_T1_34 Sch=jc_p[3]
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { JC_0[5] }]; #IO_L8N_T1_34 Sch=jc_n[3]
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { JC_0[6] }]; #IO_L2P_T0_34 Sch=jc_p[4]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { JC_0[7] }]; #IO_L2N_T0_34 Sch=jc_n[4]


##Pmod Header JD
set_false_path -to [get_ports {JD[0]}]
set_false_path -to [get_ports {JD[1]}]
set_false_path -to [get_ports {JD[2]}]
set_false_path -to [get_ports {JD[3]}]
set_false_path -to [get_ports {JD[4]}]
set_false_path -to [get_ports {JD[5]}]
set_false_path -to [get_ports {JD[6]}]
set_false_path -to [get_ports {JD[7]}]


##Pmod Header JE
set_false_path -to [get_ports {JE[0]}]
set_false_path -to [get_ports {JE[1]}]
set_false_path -to [get_ports {JE[2]}]
set_false_path -to [get_ports {JE[3]}]
set_false_path -to [get_ports {JE[4]}]
set_false_path -to [get_ports {JE[5]}]
set_false_path -to [get_ports {JE[6]}]
set_false_path -to [get_ports {JE[7]}]
...
set_clock_groups -physically_exclusive -group [get_clocks -include_generated_clocks clk_in1] -group [get_clocks -include_generated_clocks sys_clock]
